...
public class HopperBayesianBotTest {
    ...
    private List<Prescription> evilPrescriptions = Arrays.asList(
            new Prescription("a", true, 100.0f, 1),
            new Prescription("a", true, 90.0f, 1),
            new Prescription("b", true, 88.0f, 1),
            new Prescription("b", true, 89.0f, 1),
            new Prescription("c", true, 95.0f, 1),
            new Prescription("c", true, 98.0f, 1)
    );
    ...
    private List<Prescription> mostlyEvilLargeScalePrescriptions = Arrays.asList(
            ...
            new Prescription("c", true, 95.0f, 1),
            new Prescription("c", true, 98.0f, 1),
            new Prescription("c", false, 95.0f, 1),
            new Prescription("c", false, 98.0f, 1),
            new Prescription("c", false, 95.0f, 1),
            new Prescription("c", false, 98.0f, 1),
            new Prescription("c", false, 95.0f, 1),
            new Prescription("c", false, 98.0f, 1),
